...
// echo $user_id;
//เลือกข้อมูลคนที่ชอบ
$sql = "SELECT images.image_path, tb_user.user_name, tb_user.user_id, tb_information.first_name, tb_information.last_name, tb_information.gender, tb_information.age, tb_information.weight_us, tb_information.height, tb_user.user_status
        FROM images
